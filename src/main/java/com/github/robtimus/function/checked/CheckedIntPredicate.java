...
public interface CheckedIntPredicate<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedIntPredicate<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntPredicate<E> onErrorHandleChecked(CheckedPredicate<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntPredicate<E> onErrorTestChecked(CheckedIntPredicate<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedIntPredicate<E> onErrorGetCheckedAsBoolean(CheckedBooleanSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
     ...
     */
    static <X extends Throwable> CheckedIntPredicate<X> of(CheckedIntPredicate<X> predicate) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <X extends Throwable> CheckedIntPredicate<X> not(CheckedIntPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
     ...
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Throwable> CheckedIntPredicate<X> checked(IntPredicate predicate) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Throwable> CheckedIntPredicate<X> checked(IntPredicate predicate, Class<X> errorType) {
        Objects.requireNonNull(predicate);
