 ...
 */
@FunctionalInterface
public interface CheckedDoubleConsumer<X extends Exception> {
    ...
    /**
     * Returns a composed {@code CheckedDoubleConsumer} that performs, in sequence, this operation followed by the {@code after} operation.
     * If performing either operation throws an exception, it is relayed to the caller of the composed operation.
     * If performing this operation throws an exception, the {@code after} operation will not be performed.
     *
     * @param after The operation to perform after this operation.
     * @return A composed {@code CheckedDoubleConsumer} that performs in sequence this operation followed by the {@code after} operation.
     * @throws NullPointerException If {@code after} is {@code null}.
     */
    default CheckedDoubleConsumer<X> andThen(CheckedDoubleConsumer<? extends X> after) {
     ...
     */
    default <E extends Exception> CheckedDoubleConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedDoubleConsumer<E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedDoubleConsumer<E> onErrorAcceptChecked(CheckedDoubleConsumer<? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code CheckedDoubleConsumer}-shaped lambdas into {@code CheckedDoubleConsumers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code CheckedDoubleConsumer}.
     * @return The given lambda as a {@code CheckedDoubleConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Exception> CheckedDoubleConsumer<X> of(CheckedDoubleConsumer<X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static DoubleConsumer unchecked(CheckedDoubleConsumer<?> operation) {
        Objects.requireNonNull(operation);
    ...
    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link DoubleConsumer} instances to be used where {@code CheckedDoubleConsumer}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Exception> CheckedDoubleConsumer<X> checked(DoubleConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> CheckedDoubleConsumer<X> checked(DoubleConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> void invokeAndUnwrap(DoubleConsumer operation, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
