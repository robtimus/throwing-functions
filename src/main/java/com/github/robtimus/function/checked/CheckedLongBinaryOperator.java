...
public interface CheckedLongBinaryOperator<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedLongBinaryOperator<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedLongBinaryOperator<E> onErrorHandleChecked(CheckedToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedLongBinaryOperator<E> onErrorApplyChecked(CheckedLongBinaryOperator<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedLongBinaryOperator<E> onErrorGetChecked(CheckedLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsLong(t, u);
     ...
     */
    static <X extends Throwable> CheckedLongBinaryOperator<X> of(CheckedLongBinaryOperator<X> operator) {
     ...
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static <X extends Throwable> CheckedLongBinaryOperator<X> checked(LongBinaryOperator operator) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Throwable> CheckedLongBinaryOperator<X> checked(LongBinaryOperator operator, Class<X> errorType) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Throwable> long invokeAndUnwrap(LongBinaryOperator operator, long input1, long input2, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
