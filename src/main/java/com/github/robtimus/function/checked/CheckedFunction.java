...
public interface CheckedFunction<T, R, X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code CheckedFunction}-shaped lambdas into {@code CheckedFunctions}.
     *
     * @param <T> The type of the input to the function.
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedFunction}.
     ...
     * relayed to the caller. This method allows existing {@link Function} instances to be used where {@code CheckedFunction} is expected.
     *
     * @param <T> The type of the input to the function.
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
