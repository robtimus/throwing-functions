 ...
 * This is a checked-exception throwing equivalent of {@link Predicate}.
 *
...
public interface ThrowingPredicate<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingPredicate<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> Predicate<T> onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return test(t);
     ...
     */
    default <E extends Throwable> ThrowingPredicate<T, E> onErrorHandleChecked(ThrowingPredicate<? super X, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default Predicate<T> onErrorHandleUnchecked(Predicate<? super X> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return t -> {
            try {
                return test(t);
     ...
     */
    default <E extends Throwable> ThrowingPredicate<T, E> onErrorTestChecked(ThrowingPredicate<? super T, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default Predicate<T> onErrorTestUnchecked(Predicate<? super T> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingPredicate<T, E> onErrorGetCheckedAsBoolean(ThrowingBooleanSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default Predicate<T> onErrorGetUncheckedAsBoolean(BooleanSupplier fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
     ...
     */
    default Predicate<T> onErrorReturn(boolean fallback) {
        return t -> {
            try {
                return test(t);
            } catch (Error | RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code ThrowingPredicate}-shaped lambdas into {@code CheckedPredicates}.
     *
     * @param <T> The type of the input to the predicate.
     * @param <X> The type of checked exception that can be thrown.
     ...
     */
    static <T, X extends Throwable> ThrowingPredicate<T, X> of(ThrowingPredicate<T, X> predicate) {
     ...
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <T, X extends Throwable> ThrowingPredicate<T, X> checked(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <T, X extends Throwable> ThrowingPredicate<T, X> checked(Predicate<? super T> predicate, Class<X> errorType) {
        Objects.requireNonNull(predicate);
