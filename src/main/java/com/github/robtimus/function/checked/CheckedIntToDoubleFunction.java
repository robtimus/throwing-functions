...
public interface CheckedIntToDoubleFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedIntToDoubleFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntToDoubleFunction<E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntToDoubleFunction<E> onErrorApplyChecked(CheckedIntToDoubleFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedIntToDoubleFunction<E> onErrorGetChecked(CheckedDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    static <X extends Throwable> CheckedIntToDoubleFunction<X> of(CheckedIntToDoubleFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedIntToDoubleFunction<X> checked(IntToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> CheckedIntToDoubleFunction<X> checked(IntToDoubleFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
