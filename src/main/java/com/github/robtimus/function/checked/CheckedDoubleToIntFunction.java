...
public interface CheckedDoubleToIntFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedDoubleToIntFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedDoubleToIntFunction<E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedDoubleToIntFunction<E> onErrorApplyChecked(CheckedDoubleToIntFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedDoubleToIntFunction<E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     */
    static <X extends Throwable> CheckedDoubleToIntFunction<X> of(CheckedDoubleToIntFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedDoubleToIntFunction<X> checked(DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> CheckedDoubleToIntFunction<X> checked(DoubleToIntFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
