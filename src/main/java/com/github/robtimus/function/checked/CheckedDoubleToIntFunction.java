/*
 * CheckedDoubleToIntFunction.java
 ...
 */
@FunctionalInterface
public interface CheckedDoubleToIntFunction<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedDoubleToIntFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedDoubleToIntFunction<E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedDoubleToIntFunction<E> onErrorApplyChecked(CheckedDoubleToIntFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedDoubleToIntFunction<E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
    ...
    /**
     * Factory method for turning {@code CheckedDoubleToIntFunction}-shaped lambdas into {@code CheckedDoubleToIntFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedDoubleToIntFunction}.
     * @return The given lambda as a {@code CheckedDoubleToIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Exception> CheckedDoubleToIntFunction<X> of(CheckedDoubleToIntFunction<X> function) {
     ...
     * relayed to the caller. This method allows existing {@link DoubleToIntFunction} instances to be used where {@code CheckedDoubleToIntFunction} is
     * expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Exception> CheckedDoubleToIntFunction<X> checked(DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> CheckedDoubleToIntFunction<X> checked(DoubleToIntFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> int invokeAndUnwrap(DoubleToIntFunction function, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
