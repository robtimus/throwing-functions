 ...
 */
@FunctionalInterface
public interface CheckedObjIntConsumer<T, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedObjIntConsumer<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedObjIntConsumer<T, E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedObjIntConsumer<T, E> onErrorAcceptChecked(CheckedObjIntConsumer<? super T, ? extends E> fallback) {
     ...
     */
    static <T, X extends Exception> CheckedObjIntConsumer<T, X> of(CheckedObjIntConsumer<T, X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Exception> CheckedObjIntConsumer<T, X> checked(ObjIntConsumer<? super T> operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Exception> CheckedObjIntConsumer<T, X> checked(ObjIntConsumer<? super T> operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Exception> void invokeAndUnwrap(ObjIntConsumer<? super T> operation, T input1, int input2, Class<X> errorType)
            throws X {
