 ...
 */
@FunctionalInterface
public interface CheckedIntFunction<R, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedIntFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> IntFunction<R> onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default <E extends Exception> CheckedIntFunction<R, E> onErrorHandleChecked(CheckedFunction<? super X, ? extends R, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default IntFunction<R> onErrorHandleUnchecked(Function<? super X, ? extends R> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default <E extends Exception> CheckedIntFunction<R, E> onErrorApplyChecked(CheckedIntFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default IntFunction<R> onErrorApplyUnchecked(IntFunction<? extends R> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedIntFunction<R, E> onErrorGetChecked(CheckedSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default IntFunction<R> onErrorGetUnchecked(Supplier<? extends R> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default IntFunction<R> onErrorReturn(R fallback) {
        return t -> {
            try {
                return apply(t);
            } catch (RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code CheckedIntFunction}-shaped lambdas into {@code CheckedIntFunctions}.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedIntFunction}.
     * @return The given lambda as a {@code CheckedIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Exception> CheckedIntFunction<R, X> of(CheckedIntFunction<R, X> function) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <R> IntFunction<R> unchecked(CheckedIntFunction<? extends R, ?> function) {
        Objects.requireNonNull(function);
        return (IntFunction<R>) function.unchecked();
    }
     ...
     * relayed to the caller. This method allows existing {@link IntFunction} instances to be used where {@code CheckedIntFunction} is expected.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Exception> CheckedIntFunction<R, X> checked(IntFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Exception> CheckedIntFunction<R, X> checked(IntFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Exception> R invokeAndUnwrap(IntFunction<? extends R> function, int input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
