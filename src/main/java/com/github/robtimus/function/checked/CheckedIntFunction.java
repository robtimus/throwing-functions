...
public interface CheckedIntFunction<R, X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedIntFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntFunction<R, E> onErrorHandleChecked(CheckedFunction<? super X, ? extends R, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntFunction<R, E> onErrorApplyChecked(CheckedIntFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedIntFunction<R, E> onErrorGetChecked(CheckedSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     */
    static <R, X extends Throwable> CheckedIntFunction<R, X> of(CheckedIntFunction<R, X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> CheckedIntFunction<R, X> checked(IntFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> CheckedIntFunction<R, X> checked(IntFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> R invokeAndUnwrap(IntFunction<? extends R> function, int input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
