...
public interface CheckedIntToLongFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedIntToLongFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntToLongFunction<E> onErrorHandleChecked(CheckedToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntToLongFunction<E> onErrorApplyChecked(CheckedIntToLongFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedIntToLongFunction<E> onErrorGetChecked(CheckedLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsLong(t);
     ...
     */
    static <X extends Throwable> CheckedIntToLongFunction<X> of(CheckedIntToLongFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedIntToLongFunction<X> checked(IntToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> CheckedIntToLongFunction<X> checked(IntToLongFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
