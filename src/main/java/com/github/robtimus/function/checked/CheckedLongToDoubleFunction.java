...
public interface CheckedLongToDoubleFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedLongToDoubleFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedLongToDoubleFunction<E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedLongToDoubleFunction<E> onErrorApplyChecked(CheckedLongToDoubleFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedLongToDoubleFunction<E> onErrorGetChecked(CheckedDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    static <X extends Throwable> CheckedLongToDoubleFunction<X> of(CheckedLongToDoubleFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedLongToDoubleFunction<X> checked(LongToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> CheckedLongToDoubleFunction<X> checked(LongToDoubleFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
