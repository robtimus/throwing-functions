/*
 * CheckedLongToDoubleFunction.java
 ...
 * This is a checked-exception throwing equivalent of {@link LongToDoubleFunction}.
 *
 * @param <X> The type of checked exception that can be thrown.
 */
@FunctionalInterface
public interface CheckedLongToDoubleFunction<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedLongToDoubleFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> LongToDoubleFunction onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    default <E extends Exception> CheckedLongToDoubleFunction<E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default LongToDoubleFunction onErrorHandleUnchecked(ToDoubleFunction<? super X> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    default <E extends Exception> CheckedLongToDoubleFunction<E> onErrorApplyChecked(CheckedLongToDoubleFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default LongToDoubleFunction onErrorApplyUnchecked(LongToDoubleFunction fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedLongToDoubleFunction<E> onErrorGetChecked(CheckedDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default LongToDoubleFunction onErrorGetUnchecked(DoubleSupplier fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    default LongToDoubleFunction onErrorReturn(double fallback) {
        return t -> {
            try {
                return applyAsDouble(t);
            } catch (RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code CheckedLongToDoubleFunction}-shaped lambdas longo {@code CheckedLongToDoubleFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedLongToDoubleFunction}.
     * @return The given lambda as a {@code CheckedLongToDoubleFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Exception> CheckedLongToDoubleFunction<X> of(CheckedLongToDoubleFunction<X> function) {
     ...
     * relayed to the caller. This method allows existing {@link LongToDoubleFunction} instances to be used where {@code CheckedLongToDoubleFunction}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Exception> CheckedLongToDoubleFunction<X> checked(LongToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> CheckedLongToDoubleFunction<X> checked(LongToDoubleFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> double invokeAndUnwrap(LongToDoubleFunction function, long input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
