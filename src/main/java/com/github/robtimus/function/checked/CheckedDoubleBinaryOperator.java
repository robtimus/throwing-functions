...
public interface CheckedDoubleBinaryOperator<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedDoubleBinaryOperator<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedDoubleBinaryOperator<E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedDoubleBinaryOperator<E> onErrorApplyChecked(CheckedDoubleBinaryOperator<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedDoubleBinaryOperator<E> onErrorGetChecked(CheckedDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsDouble(t, u);
     ...
     */
    static <X extends Throwable> CheckedDoubleBinaryOperator<X> of(CheckedDoubleBinaryOperator<X> operator) {
     ...
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static <X extends Throwable> CheckedDoubleBinaryOperator<X> checked(DoubleBinaryOperator operator) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Throwable> CheckedDoubleBinaryOperator<X> checked(DoubleBinaryOperator operator, Class<X> errorType) {
        Objects.requireNonNull(operator);
