...
public interface CheckedToLongBiFunction<T, U, X extends Exception> {
    ...
    /**
     * Factory method for turning {@code CheckedToLongBiFunction}-shaped lambdas into {@code CheckedToLongBiFunctions}.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedToLongBiFunction}.
     ...
     * relayed to the caller. This method allows existing {@link ToLongBiFunction} instances to be used where {@code CheckedToLongBiFunction} is
     * expected.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
