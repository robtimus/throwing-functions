 ...
 * This is a checked-exception throwing equivalent of {@link LongConsumer}.
 *
...
public interface CheckedLongConsumer<X extends Throwable> {
    ...
    /**
     * Returns a composed {@code CheckedLongConsumer} that performs, in sequence, this operation followed by the {@code after} operation.
     * If performing either operation throws an exception, it is relayed to the caller of the composed operation.
     * If performing this operation throws an exception, the {@code after} operation will not be performed.
     *
     * @param after The operation to perform after this operation.
     * @return A composed {@code CheckedLongConsumer} that performs in sequence this operation followed by the {@code after} operation.
     * @throws NullPointerException If {@code after} is {@code null}.
     */
    default CheckedLongConsumer<X> andThen(CheckedLongConsumer<? extends X> after) {
     ...
     */
    default <E extends Throwable> CheckedLongConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> LongConsumer onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                accept(t);
     ...
     */
    default <E extends Throwable> CheckedLongConsumer<E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedLongConsumer<E> onErrorAcceptChecked(CheckedLongConsumer<? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code CheckedLongConsumer}-shaped lambdas into {@code CheckedLongConsumers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code CheckedLongConsumer}.
     * @return The given lambda as a {@code CheckedLongConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> CheckedLongConsumer<X> of(CheckedLongConsumer<X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static LongConsumer unchecked(CheckedLongConsumer<?> operation) {
        Objects.requireNonNull(operation);
    ...
    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link LongConsumer} instances to be used where {@code CheckedLongConsumer}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> CheckedLongConsumer<X> checked(LongConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Throwable> CheckedLongConsumer<X> checked(LongConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Throwable> void invokeAndUnwrap(LongConsumer operation, long input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
