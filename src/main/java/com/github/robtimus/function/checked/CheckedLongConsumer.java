 ...
 */
@FunctionalInterface
public interface CheckedLongConsumer<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedLongConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedLongConsumer<E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedLongConsumer<E> onErrorAcceptChecked(CheckedLongConsumer<? extends E> fallback) {
     ...
     */
    static <X extends Exception> CheckedLongConsumer<X> of(CheckedLongConsumer<X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Exception> CheckedLongConsumer<X> checked(LongConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> CheckedLongConsumer<X> checked(LongConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> void invokeAndUnwrap(LongConsumer operation, long input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
