...
public interface CheckedToIntFunction<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedToIntFunction<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedToIntFunction<T, E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedToIntFunction<T, E> onErrorApplyChecked(CheckedToIntFunction<? super T, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedToIntFunction<T, E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     */
    static <T, X extends Throwable> CheckedToIntFunction<T, X> of(CheckedToIntFunction<T, X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, X extends Throwable> CheckedToIntFunction<T, X> checked(ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Throwable> CheckedToIntFunction<T, X> checked(ToIntFunction<? super T> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Throwable> int invokeAndUnwrap(ToIntFunction<? super T> function, T input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
