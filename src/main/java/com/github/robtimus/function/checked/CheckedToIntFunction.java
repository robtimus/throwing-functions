 ...
 */
@FunctionalInterface
public interface CheckedToIntFunction<T, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedToIntFunction<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedToIntFunction<T, E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedToIntFunction<T, E> onErrorApplyChecked(CheckedToIntFunction<? super T, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedToIntFunction<T, E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
    ...
    /**
     * Factory method for turning {@code CheckedToIntFunction}-shaped lambdas into {@code CheckedToIntFunctions}.
     *
     * @param <T> The type of the input to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedToIntFunction}.
     * @return The given lambda as a {@code CheckedToIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, X extends Exception> CheckedToIntFunction<T, X> of(CheckedToIntFunction<T, X> function) {
     ...
     * relayed to the caller. This method allows existing {@link ToIntFunction} instances to be used where {@code CheckedToIntFunction} is expected.
     *
     * @param <T> The type of the input to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, X extends Exception> CheckedToIntFunction<T, X> checked(ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Exception> CheckedToIntFunction<T, X> checked(ToIntFunction<? super T> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Exception> int invokeAndUnwrap(ToIntFunction<? super T> function, T input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
