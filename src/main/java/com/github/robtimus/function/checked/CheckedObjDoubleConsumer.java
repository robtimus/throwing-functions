 ...
 * This is a checked-exception throwing equivalent of {@link ObjDoubleConsumer}.
 *
...
public interface CheckedObjDoubleConsumer<T, X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code CheckedObjDoubleConsumer}-shaped lambdas into {@code CheckedObjDoubleConsumers}.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code CheckedObjDoubleConsumer}.
     ...
     */
    @SuppressWarnings("unchecked")
    static <T> ObjDoubleConsumer<T> unchecked(CheckedObjDoubleConsumer<? super T, ?> operation) {
        Objects.requireNonNull(operation);
        return (ObjDoubleConsumer<T>) operation.unchecked();
    }

    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link ObjDoubleConsumer} instances to be used where
     * {@code CheckedObjDoubleConsumer} is expected.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
