...
public interface CheckedPredicate<T, X extends Exception> {
     ...
     */
    default CheckedPredicate<T, X> and(CheckedPredicate<? super T, ? extends X> other) {
     ...
     */
    default CheckedPredicate<T, X> negate() {
        return t -> !test(t);
    }
     ...
     * @throws NullPointerException If {@code other} is {@code null}.
     */
    default CheckedPredicate<T, X> or(CheckedPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return t -> test(t) || other.test(t);
    }
