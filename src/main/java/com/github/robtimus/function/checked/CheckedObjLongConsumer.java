 ...
 * This is a checked-exception throwing equivalent of {@link ObjLongConsumer}.
 *
 * @param <T> The type of the object argument to the operation.
 * @param <X> The type of checked exception that can be thrown.
 */
@FunctionalInterface
public interface CheckedObjLongConsumer<T, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedObjLongConsumer<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> ObjLongConsumer<T> onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return (t, u) -> {
            try {
                accept(t, u);
     ...
     */
    default <E extends Exception> CheckedObjLongConsumer<T, E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedObjLongConsumer<T, E> onErrorAcceptChecked(CheckedObjLongConsumer<? super T, ? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code CheckedObjLongConsumer}-shaped lambdas into {@code CheckedObjLongConsumers}.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code CheckedObjLongConsumer}.
     * @return The given lambda as a {@code CheckedObjLongConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Exception> CheckedObjLongConsumer<T, X> of(CheckedObjLongConsumer<T, X> operation) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <T> ObjLongConsumer<T> unchecked(CheckedObjLongConsumer<? super T, ?> operation) {
        Objects.requireNonNull(operation);
        return (ObjLongConsumer<T>) operation.unchecked();
    }

    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link ObjLongConsumer} instances to be used where
     * {@code CheckedObjLongConsumer} is expected.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Exception> CheckedObjLongConsumer<T, X> checked(ObjLongConsumer<? super T> operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Exception> CheckedObjLongConsumer<T, X> checked(ObjLongConsumer<? super T> operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Exception> void invokeAndUnwrap(ObjLongConsumer<? super T> operation, T input1, long input2, Class<X> errorType)
            throws X {
