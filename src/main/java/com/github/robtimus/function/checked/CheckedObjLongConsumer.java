...
public interface CheckedObjLongConsumer<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedObjLongConsumer<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedObjLongConsumer<T, E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedObjLongConsumer<T, E> onErrorAcceptChecked(CheckedObjLongConsumer<? super T, ? extends E> fallback) {
     ...
     */
    static <T, X extends Throwable> CheckedObjLongConsumer<T, X> of(CheckedObjLongConsumer<T, X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Throwable> CheckedObjLongConsumer<T, X> checked(ObjLongConsumer<? super T> operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Throwable> CheckedObjLongConsumer<T, X> checked(ObjLongConsumer<? super T> operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
