 ...
 */
@FunctionalInterface
public interface CheckedDoublePredicate<X extends Exception> {
     ...
     */
    default CheckedDoublePredicate<X> and(CheckedDoublePredicate<? extends X> other) {
     ...
     */
    default CheckedDoublePredicate<X> negate() {
        return t -> !test(t);
    }
     ...
     * @throws NullPointerException If {@code other} is {@code null}.
     */
    default CheckedDoublePredicate<X> or(CheckedDoublePredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return t -> test(t) || other.test(t);
    }
     ...
     */
    default <E extends Exception> CheckedDoublePredicate<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedDoublePredicate<E> onErrorHandleChecked(CheckedPredicate<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedDoublePredicate<E> onErrorTestChecked(CheckedDoublePredicate<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedDoublePredicate<E> onErrorGetCheckedAsBoolean(CheckedBooleanSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
    ...
    /**
     * Factory method for turning {@code CheckedDoublePredicate}-shaped lambdas into {@code CheckedDoublePredicates}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The lambda to return as {@code CheckedDoublePredicate}.
     * @return The given lambda as a {@code CheckedDoublePredicate}.
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Exception> CheckedDoublePredicate<X> of(CheckedDoublePredicate<X> predicate) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <X extends Exception> CheckedDoublePredicate<X> not(CheckedDoublePredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
        return (CheckedDoublePredicate<X>) predicate.negate();
    }
     ...
     * {@code CheckedDoublePredicate} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The predicate to evaluate when the returned predicate is evaluated.
     * @return A predicate that wraps any checked exception in an {@link UncheckedException}.
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Exception> CheckedDoublePredicate<X> checked(DoublePredicate predicate) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Exception> CheckedDoublePredicate<X> checked(DoublePredicate predicate, Class<X> errorType) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Exception> boolean invokeAndUnwrap(DoublePredicate predicate, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
