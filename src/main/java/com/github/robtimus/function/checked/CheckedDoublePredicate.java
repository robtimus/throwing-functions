...
public interface CheckedDoublePredicate<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedDoublePredicate<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedDoublePredicate<E> onErrorHandleChecked(CheckedPredicate<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedDoublePredicate<E> onErrorTestChecked(CheckedDoublePredicate<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedDoublePredicate<E> onErrorGetCheckedAsBoolean(CheckedBooleanSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
     ...
     */
    static <X extends Throwable> CheckedDoublePredicate<X> of(CheckedDoublePredicate<X> predicate) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <X extends Throwable> CheckedDoublePredicate<X> not(CheckedDoublePredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
     ...
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Throwable> CheckedDoublePredicate<X> checked(DoublePredicate predicate) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Throwable> CheckedDoublePredicate<X> checked(DoublePredicate predicate, Class<X> errorType) {
        Objects.requireNonNull(predicate);
