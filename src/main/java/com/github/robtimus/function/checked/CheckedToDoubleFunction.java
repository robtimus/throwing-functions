...
public interface CheckedToDoubleFunction<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedToDoubleFunction<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedToDoubleFunction<T, E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedToDoubleFunction<T, E> onErrorApplyChecked(CheckedToDoubleFunction<? super T, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedToDoubleFunction<T, E> onErrorGetChecked(CheckedDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
     ...
     */
    static <T, X extends Throwable> CheckedToDoubleFunction<T, X> of(CheckedToDoubleFunction<T, X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, X extends Throwable> CheckedToDoubleFunction<T, X> checked(ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Throwable> CheckedToDoubleFunction<T, X> checked(ToDoubleFunction<? super T> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, X extends Throwable> double invokeAndUnwrap(ToDoubleFunction<? super T> function, T input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
