...
public interface CheckedBiFunction<T, U, R, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedBiFunction<T, U, R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedBiFunction<T, U, R, E> onErrorHandleChecked(
     ...
     */
    default <E extends Exception> CheckedBiFunction<T, U, R, E> onErrorApplyChecked(
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedBiFunction<T, U, R, E> onErrorGetChecked(CheckedSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return apply(t, u);
     ...
     */
    static <T, U, R, X extends Exception> CheckedBiFunction<T, U, R, X> of(CheckedBiFunction<T, U, R, X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, R, X extends Exception> CheckedBiFunction<T, U, R, X> checked(BiFunction<? super T, ? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <T, U, R, X extends Exception> R invokeAndUnwrap(BiFunction<? super T, ? super U, ? extends R> function, T input1, U input2,
