 ...
 */
@FunctionalInterface
public interface CheckedIntConsumer<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedIntConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedIntConsumer<E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedIntConsumer<E> onErrorAcceptChecked(CheckedIntConsumer<? extends E> fallback) {
     ...
     */
    static <X extends Exception> CheckedIntConsumer<X> of(CheckedIntConsumer<X> operation) {
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Exception> CheckedIntConsumer<X> checked(IntConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> CheckedIntConsumer<X> checked(IntConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Exception> void invokeAndUnwrap(IntConsumer operation, int input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
