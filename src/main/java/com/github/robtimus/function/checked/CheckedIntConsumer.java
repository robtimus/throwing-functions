...
public interface CheckedIntConsumer<X extends Throwable> {
    ...
    /**
     * Returns a composed {@code CheckedIntConsumer} that performs, in sequence, this operation followed by the {@code after} operation.
     * If performing either operation throws an exception, it is relayed to the caller of the composed operation.
     * If performing this operation throws an exception, the {@code after} operation will not be performed.
     *
     * @param after The operation to perform after this operation.
     * @return A composed {@code CheckedIntConsumer} that performs in sequence this operation followed by the {@code after} operation.
     * @throws NullPointerException If {@code after} is {@code null}.
     */
    default CheckedIntConsumer<X> andThen(CheckedIntConsumer<? extends X> after) {
     ...
     */
    default <E extends Throwable> CheckedIntConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntConsumer<E> onErrorHandleChecked(CheckedConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntConsumer<E> onErrorAcceptChecked(CheckedIntConsumer<? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code CheckedIntConsumer}-shaped lambdas into {@code CheckedIntConsumers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code CheckedIntConsumer}.
     * @return The given lambda as a {@code CheckedIntConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> CheckedIntConsumer<X> of(CheckedIntConsumer<X> operation) {
    ...
    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link IntConsumer} instances to be used where {@code CheckedIntConsumer}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> CheckedIntConsumer<X> checked(IntConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Throwable> CheckedIntConsumer<X> checked(IntConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Throwable> void invokeAndUnwrap(IntConsumer operation, int input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
