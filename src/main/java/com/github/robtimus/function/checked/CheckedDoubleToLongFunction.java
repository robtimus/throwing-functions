 ...
 */
@FunctionalInterface
public interface CheckedDoubleToLongFunction<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedDoubleToLongFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedDoubleToLongFunction<E> onErrorHandleChecked(CheckedToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedDoubleToLongFunction<E> onErrorApplyChecked(CheckedDoubleToLongFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedDoubleToLongFunction<E> onErrorGetChecked(CheckedLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsLong(t);
     ...
     */
    static <X extends Exception> CheckedDoubleToLongFunction<X> of(CheckedDoubleToLongFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Exception> CheckedDoubleToLongFunction<X> checked(DoubleToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> CheckedDoubleToLongFunction<X> checked(DoubleToLongFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Exception> long invokeAndUnwrap(DoubleToLongFunction function, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
