/*
 * CheckedDoubleToLongFunction.java
...
public interface CheckedDoubleToLongFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedDoubleToLongFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedDoubleToLongFunction<E> onErrorHandleChecked(CheckedToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedDoubleToLongFunction<E> onErrorApplyChecked(CheckedDoubleToLongFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedDoubleToLongFunction<E> onErrorGetChecked(CheckedLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsLong(t);
    ...
    /**
     * Factory method for turning {@code CheckedDoubleToLongFunction}-shaped lambdas into {@code CheckedDoubleToLongFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedDoubleToLongFunction}.
     * @return The given lambda as a {@code CheckedDoubleToLongFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedDoubleToLongFunction<X> of(CheckedDoubleToLongFunction<X> function) {
     ...
     * relayed to the caller. This method allows existing {@link DoubleToLongFunction} instances to be used where {@code CheckedDoubleToLongFunction}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> CheckedDoubleToLongFunction<X> checked(DoubleToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> CheckedDoubleToLongFunction<X> checked(DoubleToLongFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
