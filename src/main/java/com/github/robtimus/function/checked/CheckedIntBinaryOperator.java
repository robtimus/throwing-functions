 ...
 */
@FunctionalInterface
public interface CheckedIntBinaryOperator<X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedIntBinaryOperator<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedIntBinaryOperator<E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedIntBinaryOperator<E> onErrorApplyChecked(CheckedIntBinaryOperator<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedIntBinaryOperator<E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsInt(t, u);
    ...
    /**
     * Factory method for turning {@code CheckedBinaryIntOperator}-shaped lambdas into {@code CheckedBinaryIntOpreators}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The lambda to return as {@code CheckedIntBinaryOperator}.
     * @return The given lambda as a {@code CheckedIntBinaryOperator}.
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static <X extends Exception> CheckedIntBinaryOperator<X> of(CheckedIntBinaryOperator<X> operator) {
     ...
     * {@code CheckedIntBinaryOperator} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The operator to apply when the returned operator is applied.
     * @return A binary operator that wraps any checked exception in an {@link UncheckedException}.
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static <X extends Exception> CheckedIntBinaryOperator<X> checked(IntBinaryOperator operator) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Exception> CheckedIntBinaryOperator<X> checked(IntBinaryOperator operator, Class<X> errorType) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Exception> int invokeAndUnwrap(IntBinaryOperator operator, int input1, int input2, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
