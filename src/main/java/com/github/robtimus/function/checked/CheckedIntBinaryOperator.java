...
public interface CheckedIntBinaryOperator<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedIntBinaryOperator<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedIntBinaryOperator<E> onErrorHandleChecked(CheckedToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedIntBinaryOperator<E> onErrorApplyChecked(CheckedIntBinaryOperator<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedIntBinaryOperator<E> onErrorGetChecked(CheckedIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsInt(t, u);
     ...
     */
    static <X extends Throwable> CheckedIntBinaryOperator<X> of(CheckedIntBinaryOperator<X> operator) {
     ...
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static <X extends Throwable> CheckedIntBinaryOperator<X> checked(IntBinaryOperator operator) {
        Objects.requireNonNull(operator);
     ...
     */
    static <X extends Throwable> CheckedIntBinaryOperator<X> checked(IntBinaryOperator operator, Class<X> errorType) {
        Objects.requireNonNull(operator);
