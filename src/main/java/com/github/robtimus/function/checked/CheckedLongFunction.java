 ...
 * This is a checked-exception throwing equivalent of {@link LongFunction}.
 *
...
public interface CheckedLongFunction<R, X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedLongFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> LongFunction<R> onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default <E extends Throwable> CheckedLongFunction<R, E> onErrorHandleChecked(CheckedFunction<? super X, ? extends R, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default LongFunction<R> onErrorHandleUnchecked(Function<? super X, ? extends R> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default <E extends Throwable> CheckedLongFunction<R, E> onErrorApplyChecked(CheckedLongFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default LongFunction<R> onErrorApplyUnchecked(LongFunction<? extends R> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> CheckedLongFunction<R, E> onErrorGetChecked(CheckedSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default LongFunction<R> onErrorGetUnchecked(Supplier<? extends R> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     */
    default LongFunction<R> onErrorReturn(R fallback) {
        return t -> {
            try {
                return apply(t);
            } catch (Error | RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code CheckedLongFunction}-shaped lambdas into {@code CheckedLongFunctions}.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code CheckedLongFunction}.
     * @return The given lambda as a {@code CheckedLongFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> CheckedLongFunction<R, X> of(CheckedLongFunction<R, X> function) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <R> LongFunction<R> unchecked(CheckedLongFunction<? extends R, ?> function) {
        Objects.requireNonNull(function);
        return (LongFunction<R>) function.unchecked();
    }
     ...
     * relayed to the caller. This method allows existing {@link LongFunction} instances to be used where {@code CheckedLongFunction} is expected.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> CheckedLongFunction<R, X> checked(LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> CheckedLongFunction<R, X> checked(LongFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> R invokeAndUnwrap(LongFunction<? extends R> function, long input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
