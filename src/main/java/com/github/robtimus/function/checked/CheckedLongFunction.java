 ...
 */
@FunctionalInterface
public interface CheckedLongFunction<R, X extends Exception> {
     ...
     */
    default <E extends Exception> CheckedLongFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Exception> CheckedLongFunction<R, E> onErrorHandleChecked(CheckedFunction<? super X, ? extends R, ? extends E> errorHandler) {
     ...
     */
    default <E extends Exception> CheckedLongFunction<R, E> onErrorApplyChecked(CheckedLongFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Exception> CheckedLongFunction<R, E> onErrorGetChecked(CheckedSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
     ...
     */
    static <R, X extends Exception> CheckedLongFunction<R, X> of(CheckedLongFunction<R, X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Exception> CheckedLongFunction<R, X> checked(LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Exception> CheckedLongFunction<R, X> checked(LongFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Exception> R invokeAndUnwrap(LongFunction<? extends R> function, long input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
