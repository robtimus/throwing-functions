...
public interface CheckedDoubleSupplier<X extends Throwable> {
     ...
     */
    default <E extends Throwable> CheckedDoubleSupplier<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> CheckedDoubleSupplier<E> onErrorHandleChecked(CheckedToDoubleFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> CheckedDoubleSupplier<E> onErrorGetCheckedAsDouble(CheckedDoubleSupplier<? extends E> fallback) {
     ...
     */
    static <X extends Throwable> CheckedDoubleSupplier<X> of(CheckedDoubleSupplier<X> supplier) {
     ...
     * @throws NullPointerException If {@code supplier} is {@code null}.
     */
    static <X extends Throwable> CheckedDoubleSupplier<X> checked(DoubleSupplier supplier) {
        Objects.requireNonNull(supplier);
     ...
     */
    static <X extends Throwable> CheckedDoubleSupplier<X> checked(DoubleSupplier supplier, Class<X> errorType) {
        Objects.requireNonNull(supplier);
     ...
     */
    static <X extends Throwable> double invokeAndUnwrap(DoubleSupplier supplier, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
            return supplier.getAsDouble();
