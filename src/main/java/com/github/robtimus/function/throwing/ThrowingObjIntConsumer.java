...
public interface ThrowingObjIntConsumer<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingObjIntConsumer<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingObjIntConsumer<T, E> onErrorHandleChecked(ThrowingConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingObjIntConsumer<T, E> onErrorAcceptChecked(ThrowingObjIntConsumer<? super T, ? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code ThrowingObjIntConsumer}-shaped lambdas into {@code ThrowingObjIntConsumers}.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code ThrowingObjIntConsumer}.
     * @return The given lambda as a {@code ThrowingObjIntConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Throwable> ThrowingObjIntConsumer<T, X> of(ThrowingObjIntConsumer<T, X> operation) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <T> ObjIntConsumer<T> unchecked(ThrowingObjIntConsumer<? super T, ?> operation) {
        Objects.requireNonNull(operation);
     ...
     * {@code ThrowingObjIntConsumer} is expected.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Throwable> ThrowingObjIntConsumer<T, X> checked(ObjIntConsumer<? super T> operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <T, X extends Throwable> ThrowingObjIntConsumer<T, X> checked(ObjIntConsumer<? super T> operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
