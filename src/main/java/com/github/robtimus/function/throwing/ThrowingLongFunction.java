...
public interface ThrowingLongFunction<R, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingLongFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingLongFunction<R, E> onErrorHandleChecked(
     ...
     */
    default <E extends Throwable> ThrowingLongFunction<R, E> onErrorApplyChecked(ThrowingLongFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingLongFunction<R, E> onErrorGetChecked(ThrowingSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
    ...
    /**
     * Factory method for turning {@code ThrowingLongFunction}-shaped lambdas into {@code ThrowingLongFunctions}.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingLongFunction}.
     * @return The given lambda as a {@code ThrowingLongFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> ThrowingLongFunction<R, X> of(ThrowingLongFunction<R, X> function) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <R> LongFunction<R> unchecked(ThrowingLongFunction<? extends R, ?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link LongFunction} instances to be used where {@code ThrowingLongFunction} is expected.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> ThrowingLongFunction<R, X> checked(LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> ThrowingLongFunction<R, X> checked(LongFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
