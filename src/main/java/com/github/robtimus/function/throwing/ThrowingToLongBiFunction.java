 ...
 * This is a checked-exception throwing equivalent of {@link ToLongBiFunction}.
 *
...
public interface ThrowingToLongBiFunction<T, U, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingToLongBiFunction<T, U, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> ToLongBiFunction<T, U> onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return (t, u) -> {
            try {
                return applyAsLong(t, u);
     ...
     */
    default <E extends Throwable> ThrowingToLongBiFunction<T, U, E> onErrorHandleChecked(
            ThrowingToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingToLongBiFunction<T, U, E> onErrorApplyChecked(
            ThrowingToLongBiFunction<? super T, ? super U, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingToLongBiFunction<T, U, E> onErrorGetChecked(ThrowingLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsLong(t, u);
    ...
    /**
     * Factory method for turning {@code ThrowingToLongBiFunction}-shaped lambdas into {@code ThrowingToLongBiFunctions}.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingToLongBiFunction}.
     * @return The given lambda as a {@code ThrowingToLongBiFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, X extends Throwable> ThrowingToLongBiFunction<T, U, X> of(ThrowingToLongBiFunction<T, U, X> function) {
     ...
     * relayed to the caller. This method allows existing {@link ToLongBiFunction} instances to be used where {@code ThrowingToLongBiFunction} is
     * expected.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, X extends Throwable> ThrowingToLongBiFunction<T, U, X> checked(ToLongBiFunction<? super T, ? super U> function) {
        Objects.requireNonNull(function);
