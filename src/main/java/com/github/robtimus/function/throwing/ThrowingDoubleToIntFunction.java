/*
 * ThrowingDoubleToIntFunction.java
 ...
 * This is a checked-exception throwing equivalent of {@link DoubleToIntFunction}.
 *
...
public interface ThrowingDoubleToIntFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingDoubleToIntFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> DoubleToIntFunction onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     */
    default <E extends Throwable> ThrowingDoubleToIntFunction<E> onErrorHandleChecked(ThrowingToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default DoubleToIntFunction onErrorHandleUnchecked(ToIntFunction<? super X> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     */
    default <E extends Throwable> ThrowingDoubleToIntFunction<E> onErrorApplyChecked(ThrowingDoubleToIntFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default DoubleToIntFunction onErrorApplyUnchecked(DoubleToIntFunction fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingDoubleToIntFunction<E> onErrorGetChecked(ThrowingIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default DoubleToIntFunction onErrorGetUnchecked(IntSupplier fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
     ...
     */
    default DoubleToIntFunction onErrorReturn(int fallback) {
        return t -> {
            try {
                return applyAsInt(t);
            } catch (Error | RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code ThrowingDoubleToIntFunction}-shaped lambdas into {@code ThrowingDoubleToIntFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingDoubleToIntFunction}.
     * @return The given lambda as a {@code ThrowingDoubleToIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingDoubleToIntFunction<X> of(ThrowingDoubleToIntFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static DoubleToIntFunction unchecked(ThrowingDoubleToIntFunction<?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link DoubleToIntFunction} instances to be used where {@code ThrowingDoubleToIntFunction}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingDoubleToIntFunction<X> checked(DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> ThrowingDoubleToIntFunction<X> checked(DoubleToIntFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> int invokeAndUnwrap(DoubleToIntFunction function, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
