...
public interface ThrowingIntFunction<R, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingIntFunction<R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingIntFunction<R, E> onErrorHandleChecked(ThrowingFunction<? super X, ? extends R, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingIntFunction<R, E> onErrorApplyChecked(ThrowingIntFunction<? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingIntFunction<R, E> onErrorGetChecked(ThrowingSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return apply(t);
    ...
    /**
     * Factory method for turning {@code ThrowingIntFunction}-shaped lambdas into {@code ThrowingIntFunctions}.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingIntFunction}.
     * @return The given lambda as a {@code ThrowingIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> ThrowingIntFunction<R, X> of(ThrowingIntFunction<R, X> function) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <R> IntFunction<R> unchecked(ThrowingIntFunction<? extends R, ?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link IntFunction} instances to be used where {@code ThrowingIntFunction} is expected.
     *
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R, X extends Throwable> ThrowingIntFunction<R, X> checked(IntFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    static <R, X extends Throwable> ThrowingIntFunction<R, X> checked(IntFunction<? extends R> function, Class<X> errorType) {
        Objects.requireNonNull(function);
