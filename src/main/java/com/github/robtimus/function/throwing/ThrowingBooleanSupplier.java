...
public interface ThrowingBooleanSupplier<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingBooleanSupplier}-shaped lambdas into {@code ThrowingBooleanSuppliers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param supplier The lambda to return as {@code ThrowingBooleanSupplier}.
     * @return The given lambda as a {@code ThrowingBooleanSupplier}.
     ...
     * caller. This method allows existing {@link BooleanSupplier} instances to be used where {@code ThrowingBooleanSupplier} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
