 ...
 * This is a checked-exception throwing equivalent of {@link LongSupplier}.
 *
...
public interface ThrowingLongSupplier<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingLongSupplier<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> LongSupplier onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return () -> {
            try {
                return getAsLong();
     ...
     */
    default <E extends Throwable> ThrowingLongSupplier<E> onErrorHandleChecked(ThrowingToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     * @throws NullPointerException If {@code errorHandler} is {@code null}.
     */
    default LongSupplier onErrorHandleUnchecked(ToLongFunction<? super X> errorHandler) {
        Objects.requireNonNull(errorHandler);
        return () -> {
            try {
                return getAsLong();
     ...
     */
    default <E extends Throwable> ThrowingLongSupplier<E> onErrorGetCheckedAsLong(ThrowingLongSupplier<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default LongSupplier onErrorGetUncheckedAsLong(LongSupplier fallback) {
        Objects.requireNonNull(fallback);
        return () -> {
            try {
                return getAsLong();
     ...
     */
    default LongSupplier onErrorReturn(long fallback) {
        return () -> {
            try {
                return getAsLong();
            } catch (Error | RuntimeException e) {
    ...
    /**
     * Factory method for turning {@code ThrowingLongSupplier}-shaped lambdas into {@code ThrowingLongSuppliers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param supplier The lambda to return as {@code ThrowingLongSupplier}.
     * @return The given lambda as a {@code ThrowingLongSupplier}.
     * @throws NullPointerException If {@code supplier} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongSupplier<X> of(ThrowingLongSupplier<X> supplier) {
     ...
     * caller. This method allows existing {@link LongSupplier} instances to be used where {@code ThrowingLongSupplier} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     ...
     * @throws NullPointerException If {@code supplier} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongSupplier<X> checked(LongSupplier supplier) {
        Objects.requireNonNull(supplier);
     ...
     */
    static <X extends Throwable> ThrowingLongSupplier<X> checked(LongSupplier supplier, Class<X> errorType) {
        Objects.requireNonNull(supplier);
     ...
     */
    static <X extends Throwable> long invokeAndUnwrap(LongSupplier supplier, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
            return supplier.getAsLong();
