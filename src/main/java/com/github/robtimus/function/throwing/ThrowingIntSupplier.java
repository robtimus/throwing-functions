...
public interface ThrowingIntSupplier<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingIntSupplier}-shaped lambdas into {@code ThrowingIntSuppliers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param supplier The lambda to return as {@code ThrowingIntSupplier}.
     * @return The given lambda as a {@code ThrowingIntSupplier}.
     ...
     * caller. This method allows existing {@link IntSupplier} instances to be used where {@code ThrowingIntSupplier} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
