...
public interface ThrowingObjLongConsumer<T, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingObjLongConsumer<T, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingObjLongConsumer<T, E> onErrorHandleChecked(ThrowingConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingObjLongConsumer<T, E> onErrorAcceptChecked(ThrowingObjLongConsumer<? super T, ? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code ThrowingObjLongConsumer}-shaped lambdas into {@code ThrowingObjLongConsumers}.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code ThrowingObjLongConsumer}.
     * @return The given lambda as a {@code ThrowingObjLongConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Throwable> ThrowingObjLongConsumer<T, X> of(ThrowingObjLongConsumer<T, X> operation) {
     ...
     * {@code ThrowingObjLongConsumer} is expected.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <T, X extends Throwable> ThrowingObjLongConsumer<T, X> checked(ObjLongConsumer<? super T> operation) {
        Objects.requireNonNull(operation);
