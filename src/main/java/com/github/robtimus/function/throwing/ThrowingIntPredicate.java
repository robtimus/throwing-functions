...
public interface ThrowingIntPredicate<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingIntPredicate<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingIntPredicate<E> onErrorHandleChecked(ThrowingPredicate<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingIntPredicate<E> onErrorTestChecked(ThrowingIntPredicate<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingIntPredicate<E> onErrorGetCheckedAsBoolean(ThrowingBooleanSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return test(t);
    ...
    /**
     * Factory method for turning {@code ThrowingIntPredicate}-shaped lambdas into {@code ThrowingIntPredicates}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The lambda to return as {@code ThrowingIntPredicate}.
     * @return The given lambda as a {@code ThrowingIntPredicate}.
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Throwable> ThrowingIntPredicate<X> of(ThrowingIntPredicate<X> predicate) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <X extends Throwable> ThrowingIntPredicate<X> not(ThrowingIntPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
        return (ThrowingIntPredicate<X>) predicate.negate();
    }
     ...
     * predicate is relayed to the caller. This method allows existing {@link IntPredicate} instances to be used where {@code ThrowingIntPredicate} is
     * expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The predicate to evaluate when the returned predicate is evaluated.
     ...
     * @throws NullPointerException If {@code predicate} is {@code null}.
     */
    static <X extends Throwable> ThrowingIntPredicate<X> checked(IntPredicate predicate) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Throwable> ThrowingIntPredicate<X> checked(IntPredicate predicate, Class<X> errorType) {
        Objects.requireNonNull(predicate);
     ...
     */
    static <X extends Throwable> boolean invokeAndUnwrap(IntPredicate predicate, int input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
