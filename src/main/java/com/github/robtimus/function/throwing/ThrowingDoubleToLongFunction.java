/*
 * ThrowingDoubleToLongFunction.java
 ...
 * This is a checked-exception throwing equivalent of {@link DoubleToLongFunction}.
 *
...
public interface ThrowingDoubleToLongFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingDoubleToLongFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     * @throws NullPointerException If {@code errorMapper} is {@code null}.
     */
    default <E extends RuntimeException> DoubleToLongFunction onErrorThrowAsUnchecked(Function<? super X, ? extends E> errorMapper) {
        Objects.requireNonNull(errorMapper);
        return t -> {
            try {
                return applyAsLong(t);
     ...
     */
    default <E extends Throwable> ThrowingDoubleToLongFunction<E> onErrorHandleChecked(ThrowingToLongFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingDoubleToLongFunction<E> onErrorApplyChecked(ThrowingDoubleToLongFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingDoubleToLongFunction<E> onErrorGetChecked(ThrowingLongSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsLong(t);
    ...
    /**
     * Factory method for turning {@code ThrowingDoubleToLongFunction}-shaped lambdas into {@code ThrowingDoubleToLongFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingDoubleToLongFunction}.
     * @return The given lambda as a {@code ThrowingDoubleToLongFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingDoubleToLongFunction<X> of(ThrowingDoubleToLongFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static DoubleToLongFunction unchecked(ThrowingDoubleToLongFunction<?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link DoubleToLongFunction} instances to be used where {@code ThrowingDoubleToLongFunction}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingDoubleToLongFunction<X> checked(DoubleToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> ThrowingDoubleToLongFunction<X> checked(DoubleToLongFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> long invokeAndUnwrap(DoubleToLongFunction function, double input, Class<X> errorType) throws X {
        Objects.requireNonNull(errorType);
        try {
