/*
 * ThrowingLongUnaryOperator.java
...
public interface ThrowingLongUnaryOperator<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingLongUnaryOperator}-shaped lambdas into {@code ThrowingLongUnaryOperators}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The lambda to return as {@code ThrowingLongUnaryOperator}.
     * @return The given lambda as a {@code ThrowingLongUnaryOperator}.
     ...
     * {@code ThrowingLongUnaryOperator} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The operator to apply when the returned operator is applied.
     * @return A unary operator that wraps any checked exception in an {@link UncheckedException}.
