/*
 * ThrowingLongToDoubleFunction.java
...
public interface ThrowingLongToDoubleFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingLongToDoubleFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingLongToDoubleFunction<E> onErrorHandleChecked(
     ...
     */
    default <E extends Throwable> ThrowingLongToDoubleFunction<E> onErrorApplyChecked(ThrowingLongToDoubleFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingLongToDoubleFunction<E> onErrorGetChecked(ThrowingDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsDouble(t);
    ...
    /**
     * Factory method for turning {@code ThrowingLongToDoubleFunction}-shaped lambdas longo {@code ThrowingLongToDoubleFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingLongToDoubleFunction}.
     * @return The given lambda as a {@code ThrowingLongToDoubleFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongToDoubleFunction<X> of(ThrowingLongToDoubleFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static LongToDoubleFunction unchecked(ThrowingLongToDoubleFunction<?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link LongToDoubleFunction} instances to be used where {@code ThrowingLongToDoubleFunction}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongToDoubleFunction<X> checked(LongToDoubleFunction function) {
        Objects.requireNonNull(function);
