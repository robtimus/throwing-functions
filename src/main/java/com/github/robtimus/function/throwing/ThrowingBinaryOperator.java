...
public interface ThrowingBinaryOperator<T, X extends Throwable> extends ThrowingBiFunction<T, T, T, X> {
    ...
    @Override
    default <E extends Throwable> ThrowingBinaryOperator<T, E> onErrorHandleChecked(
    ...
    @Override
    default <E extends Throwable> ThrowingBinaryOperator<T, E> onErrorApplyChecked(
            ThrowingBiFunction<? super T, ? super T, ? extends T, ? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code ThrowingBinaryOperator}-shaped lambdas into {@code ThrowingBinaryOperators}.
     *
     * @param <T> The type of the operands and result of the operator.
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The lambda to return as {@code ThrowingBinaryOperator}.
     * @return The given lambda as a {@code ThrowingBinaryOperator}.
     ...
     * {@code ThrowingBinaryOperator} is expected.
     *
     * @param <T> The type of the operands and result of the operator.
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The binary operator to apply when the returned binary operator is applied.
