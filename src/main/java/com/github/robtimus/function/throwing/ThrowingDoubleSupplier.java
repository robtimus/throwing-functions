...
public interface ThrowingDoubleSupplier<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingDoubleSupplier}-shaped lambdas into {@code ThrowingDoubleSuppliers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param supplier The lambda to return as {@code ThrowingDoubleSupplier}.
     * @return The given lambda as a {@code ThrowingDoubleSupplier}.
     ...
     * caller. This method allows existing {@link DoubleSupplier} instances to be used where {@code ThrowingDoubleSupplier} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
