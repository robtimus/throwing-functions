...
public interface ThrowingLongPredicate<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingLongPredicate}-shaped lambdas into {@code ThrowingLongPredicates}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The lambda to return as {@code ThrowingLongPredicate}.
     * @return The given lambda as a {@code ThrowingLongPredicate}.
    ...
    static <X extends Throwable> ThrowingLongPredicate<X> not(ThrowingLongPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
        return (ThrowingLongPredicate<X>) predicate.negate();
    }
     ...
     * predicate is relayed to the caller. This method allows existing {@link LongPredicate} instances to be used where {@code ThrowingLongPredicate}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param predicate The predicate to evaluate when the returned predicate is evaluated.
