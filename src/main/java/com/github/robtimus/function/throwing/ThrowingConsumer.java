...
public interface ThrowingConsumer<T, X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingConsumer}-shaped lambdas into {@code ThrowingConsumers}.
     *
     * @param <T> The type of the input to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code ThrowingConsumer}.
     * @return The given lambda as a {@code ThrowingConsumer}.
    ...
    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link Consumer} instances to be used where {@code ThrowingConsumer} is
     * expected.
     *
     * @param <T> The type of the input to the operation.
     * @param <X> The type of checked exception that can be thrown.
