/*
 * ThrowingToDoubleBiFunction.java
...
public interface ThrowingToDoubleBiFunction<T, U, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingToDoubleBiFunction<T, U, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingToDoubleBiFunction<T, U, E> onErrorHandleChecked(
     ...
     */
    default <E extends Throwable> ThrowingToDoubleBiFunction<T, U, E> onErrorApplyChecked(
            ThrowingToDoubleBiFunction<? super T, ? super U, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingToDoubleBiFunction<T, U, E> onErrorGetChecked(ThrowingDoubleSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return applyAsDouble(t, u);
    ...
    /**
     * Factory method for turning {@code ThrowingToDoubleBiFunction}-shaped lambdas into {@code ThrowingToDoubleBiFunctions}.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingToDoubleBiFunction}.
     * @return The given lambda as a {@code ThrowingToDoubleBiFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, X extends Throwable> ThrowingToDoubleBiFunction<T, U, X> of(ThrowingToDoubleBiFunction<T, U, X> function) {
     ...
     */
    @SuppressWarnings("unchecked")
    static <T, U> ToDoubleBiFunction<T, U> unchecked(ThrowingToDoubleBiFunction<? super T, ? super U, ?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link ToDoubleBiFunction} instances to be used where {@code ThrowingToDoubleBiFunction} is
     * expected.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, X extends Throwable> ThrowingToDoubleBiFunction<T, U, X> checked(ToDoubleBiFunction<? super T, ? super U> function) {
        Objects.requireNonNull(function);
