...
public interface ThrowingBiFunction<T, U, R, X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingBiFunction<T, U, R, E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingBiFunction<T, U, R, E> onErrorHandleChecked(
     ...
     */
    default <E extends Throwable> ThrowingBiFunction<T, U, R, E> onErrorApplyChecked(
            ThrowingBiFunction<? super T, ? super U, ? extends R, ? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingBiFunction<T, U, R, E> onErrorGetChecked(ThrowingSupplier<? extends R, ? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return (t, u) -> {
            try {
                return apply(t, u);
    ...
    /**
     * Factory method for turning {@code ThrowingBiFunction}-shaped lambdas into {@code ThrowingBiFunctions}.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     * @param <R> The type of the result of the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingBiFunction}.
     * @return The given lambda as a {@code ThrowingBiFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, R, X extends Throwable> ThrowingBiFunction<T, U, R, X> of(ThrowingBiFunction<T, U, R, X> function) {
     ...
     * relayed to the caller. This method allows existing {@link BiFunction} instances to be used where {@code ThrowingBiFunction} is expected.
     *
     * @param <T> The type of the first argument to the function.
     * @param <U> The type of the second argument to the function.
     * @param <R> The type of the result of the function.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U, R, X extends Throwable> ThrowingBiFunction<T, U, R, X> checked(BiFunction<? super T, ? super U, ? extends R> function) {
        Objects.requireNonNull(function);
