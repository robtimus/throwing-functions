/*
 * ThrowingObjDoubleConsumer.java
...
public interface ThrowingObjDoubleConsumer<T, X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingObjDoubleConsumer}-shaped lambdas into {@code ThrowingObjDoubleConsumers}.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code ThrowingObjDoubleConsumer}.
     * @return The given lambda as a {@code ThrowingObjDoubleConsumer}.
     ...
     * {@code ThrowingObjDoubleConsumer} is expected.
     *
     * @param <T> The type of the object argument to the operation.
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
