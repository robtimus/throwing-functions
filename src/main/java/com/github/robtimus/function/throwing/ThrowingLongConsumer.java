...
public interface ThrowingLongConsumer<X extends Throwable> {
    ...
    /**
     * Returns a composed {@code ThrowingLongConsumer} that performs, in sequence, this operation followed by the {@code after} operation.
     * If performing either operation throws an exception, it is relayed to the caller of the composed operation.
     * If performing this operation throws an exception, the {@code after} operation will not be performed.
     *
     * @param after The operation to perform after this operation.
     * @return A composed {@code ThrowingLongConsumer} that performs in sequence this operation followed by the {@code after} operation.
     ...
     */
    default <E extends Throwable> ThrowingLongConsumer<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingLongConsumer<E> onErrorHandleChecked(ThrowingConsumer<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingLongConsumer<E> onErrorAcceptChecked(ThrowingLongConsumer<? extends E> fallback) {
    ...
    /**
     * Factory method for turning {@code ThrowingLongConsumer}-shaped lambdas into {@code ThrowingLongConsumers}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The lambda to return as {@code ThrowingLongConsumer}.
     * @return The given lambda as a {@code ThrowingLongConsumer}.
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongConsumer<X> of(ThrowingLongConsumer<X> operation) {
    ...
    /**
     * Returns an operation that performs the {@code operation} operation to its input. Any checked exception thrown by the {@code operation}
     * operation is relayed to the caller. This method allows existing {@link LongConsumer} instances to be used where {@code ThrowingLongConsumer}
     * is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operation The operation to perform when the returned operation is performed.
     ...
     * @throws NullPointerException If {@code operation} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongConsumer<X> checked(LongConsumer operation) {
        Objects.requireNonNull(operation);
     ...
     */
    static <X extends Throwable> ThrowingLongConsumer<X> checked(LongConsumer operation, Class<X> errorType) {
        Objects.requireNonNull(operation);
