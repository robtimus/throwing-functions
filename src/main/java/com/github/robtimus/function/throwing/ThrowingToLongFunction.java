...
public interface ThrowingToLongFunction<T, X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingToLongFunction}-shaped lambdas into {@code ThrowingToLongFunctions}.
     *
     * @param <T> The type of the input to the function.
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingToLongFunction}.
     * @return The given lambda as a {@code ThrowingToLongFunction}.
     ...
     * relayed to the caller. This method allows existing {@link ToLongFunction} instances to be used where {@code ThrowingToLongFunction} is
     * expected.
     *
     * @param <T> The type of the input to the function.
     * @param <X> The type of checked exception that can be thrown.
