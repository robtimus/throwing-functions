/*
 * ThrowingLongToIntFunction.java
...
public interface ThrowingLongToIntFunction<X extends Throwable> {
     ...
     */
    default <E extends Throwable> ThrowingLongToIntFunction<E> onErrorThrowAsChecked(Function<? super X, ? extends E> errorMapper) {
     ...
     */
    default <E extends Throwable> ThrowingLongToIntFunction<E> onErrorHandleChecked(ThrowingToIntFunction<? super X, ? extends E> errorHandler) {
     ...
     */
    default <E extends Throwable> ThrowingLongToIntFunction<E> onErrorApplyChecked(ThrowingLongToIntFunction<? extends E> fallback) {
     ...
     * @throws NullPointerException If {@code fallback} is {@code null}.
     */
    default <E extends Throwable> ThrowingLongToIntFunction<E> onErrorGetChecked(ThrowingIntSupplier<? extends E> fallback) {
        Objects.requireNonNull(fallback);
        return t -> {
            try {
                return applyAsInt(t);
    ...
    /**
     * Factory method for turning {@code ThrowingLongToIntFunction}-shaped lambdas into {@code ThrowingLongToIntFunctions}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The lambda to return as {@code ThrowingLongToIntFunction}.
     * @return The given lambda as a {@code ThrowingLongToIntFunction}.
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongToIntFunction<X> of(ThrowingLongToIntFunction<X> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static LongToIntFunction unchecked(ThrowingLongToIntFunction<?> function) {
        Objects.requireNonNull(function);
     ...
     * relayed to the caller. This method allows existing {@link LongToIntFunction} instances to be used where {@code ThrowingLongToIntFunction} is
     * expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param function The function to apply when the returned function is applied.
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <X extends Throwable> ThrowingLongToIntFunction<X> checked(LongToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    static <X extends Throwable> ThrowingLongToIntFunction<X> checked(LongToIntFunction function, Class<X> errorType) {
        Objects.requireNonNull(function);
