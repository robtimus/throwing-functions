...
public interface ThrowingIntUnaryOperator<X extends Throwable> {
    ...
    /**
     * Factory method for turning {@code ThrowingIntUnaryOperator}-shaped lambdas into {@code ThrowingIntUnaryOperators}.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The lambda to return as {@code ThrowingIntUnaryOperator}.
     * @return The given lambda as a {@code ThrowingIntUnaryOperator}.
     ...
     * {@code ThrowingIntUnaryOperator} is expected.
     *
     * @param <X> The type of checked exception that can be thrown.
     * @param operator The operator to apply when the returned operator is applied.
     * @return A unary operator that wraps any checked exception in an {@link UncheckedException}.
